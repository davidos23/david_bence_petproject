---
title: "Szívbetegség előrejelzése - ANN"
...
Random Forest után most folytassuk a neurális hálló modellünk felépítésével!
...
cfm
```
Az alábbi mutatókat szeretnénk maximalizálni, de accuracy-t előnyben részesítjük:
```{r}
...
Most menjünk tovább az Ensemble módszer felépítésére!
