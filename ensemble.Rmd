...
Ennek összetevői az eddigi legjobbnak bizonyult neurális háló, és random forest modelleket fogunk használni, illetve harmadik összetevőként beleveszünk egy egyszerű logit modellt.
...
Kidobjuk a magas p értékkel rendelkező változókat, és lefuttatjuk K = 100 db-szor a becslést, majd megnézzük a mutatóinkat:
```{r}
K=1000
...
Nem túl erősek a mutatók (59%-os pontosság).
